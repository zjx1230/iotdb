...
public class experimentITest {
  ...
  //  private static SessionPool sessionPool = new SessionPool("127.0.0.1", 6667, "root", "root", 10);
...
//              "CREATE INDEX ON root.sg1.d" + i + ".s" + j + " WITH INDEX=ELB_INDEX, BLOCK_SIZE=5");
    ...
    boolean enable = IoTDBDescriptor.getInstance().getConfig().isEnableIndex();
...
//        }
        ...
        String insertSQL =
            String.format("INSERT INTO %s(timestamp%s) VALUES (%d%s)", deviceId,
                measurementsSQL.toString(), time, valuesSQL.toString());
