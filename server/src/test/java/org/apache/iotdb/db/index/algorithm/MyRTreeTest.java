...
import org.apache.iotdb.db.index.algorithm.MyRTree.RNode;
import org.apache.iotdb.db.index.algorithm.MyRTree.SeedsPicker;
...
public class MyRTreeTest {
  ...
  public void testRTreeToString() {
    ...
    MyRTree<Integer> rTree = new MyRTree<>(4, 2, 2, SeedsPicker.LINEAR);
    for (int i = 0; i < 20; i++) {
  ...
  public void testRTreeSerialization() throws IOException {
    ...
    MyRTree<Integer> afterRTree = MyRTree.deserialize(byteBuffer, deserial);
    System.out.println(rTree);
   ...
   * </p>
   */
  public boolean checkRTree(MyRTree rTree) {
    return checkNode(rTree, rTree.root);
  }

  private boolean checkNode(MyRTree rTree, RNode node) {
