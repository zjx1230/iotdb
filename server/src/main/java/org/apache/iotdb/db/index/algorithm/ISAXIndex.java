 ...
 * pruning.
 *
 * <p>In some indexing techniques, ISAXIndex is composed of a list of subtrees.Suppose the input
 * series is divided into {@code b} segments, all data will be first divided into {@code 2^b}
