 ...
 * size).
 */
public class BasicPreprocessor implements IPreprocess {
  ...
  public BasicPreprocessor(int windowRange, int equispacedLength, WindowWidthType widthType,
  ...
  public BasicPreprocessor(int subSeqLength) {
