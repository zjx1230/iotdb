...
//    for (File file : new File("/Users/tianyu/2019秋季学期/iotdb/server/target/iotdb-server-0.11.2/data/data/unsequence/root.group_9/unseq").listFiles()) {
//      if (file.getName().endsWith(".tsfile")) {
//        Pair<String, String> params = new Pair<>(
//            file.getAbsolutePath(), "root.group_9.d_69.s_299");
//        System.out.println(file.getName() + ":" + printTsFileSinglePath(params));
//      }
//    }
    Pair<String, String> params = new Pair<>(
